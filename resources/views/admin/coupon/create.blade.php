...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Thêm Mới Khuyến Mại <a href="{{route('khuyen-mai.index')}}" class="btn btn-flat btn-success "><i
                        ...
                        <form action="{{ route('khuyen-mai.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('code') }}" name="code" id="code" placeholder="Nhập mã ........">
                                     @if($errors->has('code'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('percent') ? old('percent') : 0 }}" min="0" max="100" class="form-control" name="percent">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('value') ? old('value') : 0 }}" min="0"  class="form-control" name="value">
                                </div>
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        ...
                                        <option value="1" >Khuyến mại cho khách víp</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="unti">
                                        ...
                                        <option value="1" >Giá Giảm (VNĐ)</option>
                                 ...
                                 <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_active" value="1" {{ (old('is_active') == 1) ? 'checked' :'' }}> <b>Kích Hoạt</b>
                                    </label>
                                </div>
                            </div>
                            <!-- /.box-body -->
