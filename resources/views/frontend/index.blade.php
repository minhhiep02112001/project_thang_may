            ...
            @foreach($categories as $key=>$category)
                <div id="ctl00_ContentPlaceHolder1_PageView1_ctl00_RepeaterCategory_ctl01_Panel1"
                    ...
                    <div class="site-section" id="san-pham-ngoai-that">
                        ...
                        <div class="text-center"><a href="{{route('shop.product' , ['slug'=> $product->slug])}}"
                                                    class="btn btn-primary mr-2 mb-2">Xem thêm</a></div>
                    </div>
                </div>
            @endforeach
                        ...
                        <div class="container">
                            <div class="row mb-5 justify-content-center">
                                <div class="col-md-12 text-center text-title">
                                    <h2 class="section-title mb-3 text-black"><a href="./du-an.html">Dự án</a>
                                    </h2>
                                </div>
                            </div>
                            <div class="row">
                                @foreach($product_projects as $key=>$item)
                                    <div class="col-xs-6 col-sm-4 col-md-3 text-center">
                                        <div class="second-step">
                                            ...
                                            <h3 class="text-dark"><a
                                                    href="{{route('shop.product' , ['slug'=> $item->slug])}}l">{{$item->name}}</a></h3>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        <div class="text-center"><a href="./du-an.html" class="btn btn-primary mr-2 mb-2">Xem
                                thêm</a></div>
                    </div>
                </div>
            @endif
